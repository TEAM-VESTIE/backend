...
import static com.vestie.vestie.survey.fixture.SurveyFixture.설문;
...
class SurveyServiceTest {
    ...
    class 설문조회_시 {
        ...
        void setup() {
            ...
            Long registeredId = surveyService.register(surveyRegisterCommand);
            survey = surveyRepository.findById(registeredId).get();
            surveyService.register(surveyRegisterCommand);
        }
        ...
        void 설문_리스트가_조회된다() {
            ...
            assertThat(allSurvey.get(0))
                    ...
                    .comparingOnlyFieldsOfTypes(Survey.class)
                    .ignoringFields("id")
                    .isEqualTo(survey);
            assertThat(allSurvey.size())
                    .isEqualTo(2);
        }
